...
import {
  ...
  IntlShape,
  MessageDescriptor,
} from 'D:/dingwj/node_modules/react-intl';
import { ApplyPluginsType } from 'umi';
import { event, LANG_CHANGE_EVENT } from './locale';
// @ts-ignore
import warning from 'D:/dingwj/node_modules/warning/warning.js';

import { plugin } from '../core/umiExports';

export * from 'D:/dingwj/node_modules/react-intl';
...
export const localeInfo: {[key: string]: any} = {
  'en-US': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('D:/dingwj/src/locales/en-US.js')),
    },
    locale: 'en-US',
  ...
  'zh-CN': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('D:/dingwj/src/locales/zh-CN.js')),
    },
    locale: 'zh-CN',
